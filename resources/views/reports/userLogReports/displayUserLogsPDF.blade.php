...
<body>
    ...
    <span class="align-center"><h3>USER LOG REPORT</h3></span>
    <table cellspacing="0" width="700px">
        <tr class="bordered-row" >
            <td class="align-center" style="width: fit-content"><p>Log ID</p></td>
            <td class="align-center" style="width: 200px"><p>Name</p></td>
            <td class="align-center" style="width: 300px"><p>Description</p></td>
            <td class="align-center" style="width: 150px"><p>Date and Time</p></td>
        </tr>
{{--        {{ddd($logs->user_name)}}--}}
        @foreach($user_logs as $userlog)
            <tr class="bordered-row">
                <td class="bordered-data align-center"><p>{{$userlog->id}}</p></td>
                <td class="bordered-data align-center"><p>{{$userlog->user_name}}</p></td>
                <td class="bordered-data align-center"><p>{{$userlog->action_done}}</p></td>
                <td class="bordered-data align-center"><p>{{$userlog->date_done}} {{$userlog->time_done}}</p></td>
            </tr>
        @endforeach
    </table>
