...
<body>
    ...
    <span class="align-center"><h3>LOG REPORT</h3></span>
...
{{--        {{ddd($logs->user_name)}}--}}
        @foreach($logs as $log_in)
            <tr class="bordered-row">
                <td class="bordered-data align-center"><p>{{$log_in->id}}</p></td>
                <td class="bordered-data align-center"><p>{{$log_in->user_name}}</p></td>
                <td class="bordered-data align-center"><p>{{$log_in->action_done}}</p></td>
                <td class="bordered-data align-center"><p>{{$log_in->date_done}} {{$log_in->time_done}}</p></td>
            </tr>
        @endforeach
    </table>
