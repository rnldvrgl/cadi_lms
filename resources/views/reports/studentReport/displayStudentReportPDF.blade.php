...
<span class="align-center"><h3>STUDENT REPORT</h3></span>
    <table cellspacing="0" width="700px">
        <tr class="bordered-row">
            <td class="align-center" style="width: 150px"><p>Student Name</p></td>
            <td class="align-center" style="width: 100px"><p>Email</p></td>
            <td class="align-center" style="width: 100px"><p>Grade</p></td>
            <td class="align-center" style="width: 100px"><p>Section</p></td>
        </tr>
        @foreach($students as $student)
            <tr class="bordered-row">
                <td class="bordered-data align-center"><p>{{$student->name}}</p></td>
                <td class="bordered-data align-center"><p>{{$student->email}}</p></td>
                <td class="bordered-data align-center"><p>{{$student->grade}}</p></td>
                <td class="bordered-data align-center"><p>{{$student->section}}</p></td>
            </tr>
        @endforeach
    </table>
