                        ...
                        <form action="../../process-return" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="hidden" name="return_book_id" value="{{$borrow_info->id}}">
                                    <input type="hidden" name="return_user_id" value="{{$user_info->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" id="return_date" value="{{date("d/m/Y-H:i:s")}}" name="return_date" required readonly>
                            </div>
{{--                            <div class="form-group">--}}
