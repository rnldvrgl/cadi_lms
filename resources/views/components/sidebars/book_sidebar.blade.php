    ...
    @if(Session::get('user_type') == "admin" || Session::get('user_type') == "librarian")
        ...
        <li class="nav-item active">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded  collapsed">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a id="QrReturn" class="collapse-item" href="#">Return Requests</a>
                <a class="collapse-item" href="borrow-requests">Borrow Requests</a>
